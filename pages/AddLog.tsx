  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center gap-4 mb-2">
        ...
        <h2 className="text-2xl font-bold text-stone-800">新增紀錄</h2>
      </div>
                    ...
                    {actions.litter && (
                        <div className="mt-4 animate-fade-in space-y-4 px-1 pb-2">
                            ...
                            <button
                                ...
                                className={`w-full py-4 px-2 rounded-xl text-lg font-bold border flex items-center justify-center gap-2 transition-all ${
                                    isLitterClean 
                                    ...
                                    <div className="border-t border-stone-100 pt-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <button
                                                ...
                                                className={`py-3 px-2 rounded-xl text-sm font-bold border flex items-center justify-center gap-2 transition-all ${
                                                    urineStatus === 'HAS_URINE' 
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            <button
                                                ...
                                                className={`py-2 px-1 rounded-lg text-sm font-bold border flex flex-col items-center gap-1 transition-all ${
                                                    stoolType === 'FORMED' 
